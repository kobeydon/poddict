"""
Django settings for poddict project.
...
SECRET_KEY = 'wg(4@og9mcu8l6#8%ssic!4xnc@&#7om$q2kbrpr&qr=qn8h=d'
...
WSGI_APPLICATION = 'poddict.wsgi.application'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'servstatic')
